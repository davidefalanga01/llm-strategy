    ...
    def on_trading_iteration(self):
        ...
        if last_price != None:
            if cash > (quantity * last_price):
                if sentiment == 'positive' and probability >= 0.9: # Buy
                    ...
                    self.last_trade = "buy"
                elif sentiment == 'negative' and probability >= 0.9: # Sell
...
if __name__ == '__main__':
    ...
    result, strat_obj = Trader.run_backtest(
        ...
        parameters={"cash_at_risk": 0.25, "coin": coin, "coin_name": coin_name},
        **kwargs,
    )
